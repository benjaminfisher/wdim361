...
?>
	...
	<table>
		...
		<?php while($row = $result2->fetch_array()){ ?>
				<tr>
				<td><a href="addProduct.php?id=<?php print $row['id']; ?>">edit</a> 
					<a href="delWarn.php?id=<?php print $row['id']; ?>">del</a></td>
				<td><?php print $row['id']; ?></td>
				<td><img src="../images/t_<?php print $row['image'] ?>" width="50" alt="" /></td>
